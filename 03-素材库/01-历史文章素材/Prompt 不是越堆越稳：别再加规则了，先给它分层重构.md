---
title: "Prompt 不是越堆越稳：别再加规则了，先给它分层重构"
source: "https://mp.weixin.qq.com/s/FyDoO8UxTsRFroDxAmedbQ"
author:
  - "[[艾启蒙]]"
published:
created: 2026-08-09
description: "代码到点该重构就重构，Prompt 也一样。与其等 AI 升级救你，不如先把你那份自己都读不动的 Prompt，按层理一遍。"
tags:
  - "clippings"
---
艾启蒙 AI启蒙学习 *2026年8月5日 11:17*

PROMPT ENGINEERING · 实战方法论2026.08

规则越加，AI 越听话？

把 Prompt 从 1500 砍到 300 行

Agent Skill 分层重构法

位置即优先级 · 外置减负 · 首尾强化 · 表格化
...
那次Flask 项目，核心逻辑挤在两份 Python 文件里，flask\_web\_server.py 和 web\_stock\_analyzer.py，每份都有几千行，臃肿得不行。

崩的那次，卡在 SSE 同步。功能跑不通，我得排查到底哪儿断了。打开 flask\_web\_server.py，光标从第一行往下拖，几千行密密麻麻，我想找 SSE 那段 started、heartbeat、stream-fallback 的处理逻辑，记得大概在文件中后段，具体哪一行根本记不清。Ctrl+F 搜关键词，跳出来一堆位置，有初始化的、有注册路由的、有错误处理的，散在好几个地方，我得来回跳着看，拼凑出完整的调用链。
...
![几千行文件排查崩溃场景](https://mmbiz.qpic.cn/mmbiz_png/POXYnuKicKs140XuoNQEy0TLst8LouaMBibcicUbwsGojpH1WhlLHDUq4UrnhbwkOa0sVOic7nwz1pwzApu5jBFeb09HLeD2DIPV1bYhsfxtJR8/640?wx_fmt=png&from=appmsg#imgIndex=0)
...
![代码到提示词的衔接流程图](https://mmbiz.qpic.cn/mmbiz_png/POXYnuKicKs0mWia0IdFGBDYzyID3XBYar5dFaNMESQ794ZWr5YIYXKqFBbsb6QRhXCo9UrfP09riaM3ZQG2ia9OTibvJKvnHCrCicVzGnawrN9xg/640?wx_fmt=png&from=appmsg#imgIndex=1)
...
![四层架构示意图](https://mmbiz.qpic.cn/mmbiz_png/POXYnuKicKs1zAvUib2qqyicuXmAtEDKAr7iaDoMicPDgpibEE0HThLoY0LibiaElibfaPIUmQAu6icgKgHv1eXBtIdzNBoKwDwPAliaqQqWlUeJNJ1tvs/640?wx_fmt=png&from=appmsg#imgIndex=2)
...
![散文与表格改造前后对比](https://mmbiz.qpic.cn/sz_mmbiz_png/POXYnuKicKs084VlRvicO1gJPGKzMMd1yHA5NKf1FX3nRu2Nql6HeNDdlMUGZH1ibpzyNUQe31LhaSw2k0iaek5BNQk0fickzicw4QYOVTWBEuKhc/640?wx_fmt=png&from=appmsg#imgIndex=3)
